...
updater=/usr/share/updatepostintaller/Postinstaller32.sh
source=/usr/bin/Postinstaller32.sh
update=/usr/share/updatepostintaller/Postinstaller32.sh
...
P_RUN=$(yad --center --image="/usr/share/icons/acciones/topicon.png" --image-on-top --icons --class="PostInstallerF" --name="PostInstallerF" --window-icon="/usr/share/icons/Postinstaller1.svg" --item-width="110" --read-dir="/usr/share/Postdesktopfiles" --width="435" --height="435" --title="PostInstallerF" --auto-kill --text="\n<b>Double click</b> an item to select an action:" --button="Website:0" --button="Close:1")
