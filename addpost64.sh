...
yum -y install flash-plugin hal-flash | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Instalando flash-plugin" --text="Por favor espere...." --pulsate --auto-close --width=350
...
su $noti -c 'notify-send "PostInstallerF" "Has been completed installation of Anki" -i "/usr/share/icons/pinguino.png" -t 5000'
    ...
    wine(){
            yum -y install wine cabextract winetricks | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Instalando Wine" --text="Por favor espere...." --pulsate --auto-close --width=350
