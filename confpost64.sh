...
# +--------------------------------------------------------------------------------+
# FEDORA 19 y 20 CONFPOST 1.2.3 64 BITS

# ACTUALIZACION DE CONFPOST
updater=/usr/share/updatepostintaller/confpost64.sh
if [ -f $updater ]; then
rm -f /usr/share/updatepostintaller/confpost64.sh
...
xterm -e 'wget -c -P/usr/share/updatepostintaller/ https://raw.github.com/kuboosoft/postinstallerf/master/confpost64.sh'
else
mkdir /usr/share/updatepostintaller/
xterm -e 'wget -c -P/usr/share/updatepostintaller/ https://raw.github.com/kuboosoft/postinstallerf/master/confpost64.sh'
fi 

source=/usr/bin/postinstallerf/confpost64.sh
update=/usr/share/updatepostintaller/confpost64.sh
...
cp -f /usr/share/updatepostintaller/confpost64.sh /usr/bin/postinstallerf/ 
...
# +--------------------------------------------------------------------------------------------------+
    ...
    generateInstallMenu(){ 
            im="yad --center --image="/usr/share/icons/acciones/conf.png" --image-on-top --class="Configure-Tuning" --window-icon="/usr/share/icons/acciones/conf.png" --list --radiolist  --width=800 --height=600 --title \"PostInstallerF for Fedora 64bit (Ver 1.2.0)\" --text \"Select items from the list below\" "
...
if ! $installed | grep "Compatibilidad 32bits" > /dev/null; then
                    im=$im"FALSE \"Compatibilidad 32bits\"    \"Instala dependencias para forzar el funcionamiento de paquetes de 32 bits en plataformas de 64 \" \"ACTIVO  \"  "
            fi
...
if [ -f /etc/X11/xorg.conf.d/50-synaptics.conf ]; then
                    ...
                    im=$im"FALSE \"Activate Touchpad\"    \"Enables the Touchpad from start\" \"ACTIVO  \"  "
else
                    im=$im"FALSE \"Activate Touchpad\"    \"Enables the Touchpad from start\" \"NO ACTIVO  \"  "
fi
            fi
...
if ! $installed | grep "Compatibility 32bits" > /dev/null; then
                    im=$im"FALSE \"Compatibility 32bits\"    \"Installing operating dependencies for 32-bit packets on 64 \" \"ACTIVATED  \"  "
            fi
...
if echo $choice | grep "Compatibilidad 32bits" > /dev/null; then
                    compati32
            fi

if echo $choice | grep "Compatibility 32bits" > /dev/null; then
                    compati32
            fi
...
pendientes(){
            yum-complete-transaction | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Completando Instalaciones pendientes" --text="Por favor espere...." --pulsate --auto-close --width=350
...
gnodesk(){
            yum -y install @gnome-desktop | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Instalando escritorio Gnome/Gnome Shell" --text="Por favor espere...." --pulsate --auto-close --width=350
...
yum -y install razorqt | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Instalando escritorio Razor-qt" --text="Por favor espere...." --pulsate --auto-close --width=350
...
yum -y install --skip-broken arts.i686 audiofile.i686 bzip2-libs.i686 cairo.i686 cyrus-sasl-lib.i686 dbus-libs.i686 directfb.i686 esound-libs.i686 fltk.i686 freeglut.i686 gtk2.i686 hal-libs.i686 imlib.i686 lcms-libs.i686 lesstif.i686 libacl.i686 libao.i686 libattr.i686 libcap.i686 libdrm.i686 libexif.i686 libgnomecanvas.i686 libICE.i686 libieee1284.i686 libsigc++20.i686 libSM.i686 libtool-ltdl.i686 libusb.i686 libwmf.i686 libwmf-lite.i686 libX11.i686 libXau.i686 libXaw.i686 libXcomposite.i686 libXdamage.i686 libXdmcp.i686 libXext.i686 libXfixes.i686 libxkbfile.i686 libxml2.i686 libXmu.i686 libXp.i686 libXpm.i686 libXScrnSaver.i686 libxslt.i686 libXt.i686 libXtst.i686 libXv.i686 libXxf86vm.i686 lzo.i686 mesa-libGL.i686 mesa-libGLU.i686 nas-libs.i686 nss_ldap.i686 cdk.i686 openldap.i686 pam.i686 popt.i686 pulseaudio-libs.i686 sane-backends-libs-gphoto2.i686 sane-backends-libs.i686 SDL.i686 svgalib.i686 unixODBC.i686 zlib.i686 compat-expat1.i686 compat-libstdc++-33.i686 openal-soft.i686 alsa-oss-libs.i686 redhat-lsb.i686 alsa-plugins-pulseaudio.i686 alsa-plugins-oss.i686 alsa-lib.i686 nspluginwrapper.i686 libXv.i686 libXScrnSaver.i686 qt.i686 qt-x11.i686 pulseaudio-libs.i686 pulseaudio-libs-glib2.i686 alsa-plugins-pulseaudio.i686 | pv -n 2>&1 | yad --class="Installing" --window-icon="/usr/share/icons/acciones/topicon.png" --image="/usr/share/icons/icoinstall2.png" --image-on-top --progress --title "Instalando librerias de compatibilidad para plataformas de 32bit" --text="Por favor espere...." --pulsate --auto-close --width=350
